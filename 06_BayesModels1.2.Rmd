...
*This section contains our previous models model attempts if you are interested in seeing our journey! Otherwise, you can skip to the "Part 2: Becoming A Proud Bayesian" section.*
...
Since it appears to be a linear relationship, we gain proceeded with a linear model.
