...
This tab takes you on a tour of the data-cleaning process. It is extensive and will help guide you, should you want to undertake a college ranking project.
...
### Load data, select and rename columns to distinguish by year, omit NA values

**If you want to reproduce our work, make sure to change your file path :)**
```{r message=FALSE, warning=FALSE}
myData1617 <- read.csv(file = "/Users/kavyashetty/Desktop/Bayesian Stats/MERGED2016_17_PP.csv")
...
```{r message=FALSE, warning=FALSE}
myData1516 <- read.csv(file = "/Users/kavyashetty/Desktop/Bayesian Stats/MERGED2015_16_PP.csv")
...
```{r message=FALSE, warning=FALSE}
myData1415 <- read.csv(file = "/Users/kavyashetty/Desktop/Bayesian Stats/MERGED2014_15_PP.csv")
...
```{r message=FALSE, warning=FALSE}
USNewsUniversity <- read_excel("/Users/kavyashetty/Desktop/Bayesian Stats/USNewsUniversity.xlsx")
...
```{r message=FALSE, warning=FALSE}
USNewsLiberalArts <- read_excel("/Users/kavyashetty/Desktop/Bayesian Stats/USNewsLiberalArts.xlsx")
...
### Check and set each variable classification
```{r message=FALSE, warning=FALSE}
